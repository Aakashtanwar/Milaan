...
const hi = {
  appName: 'मिलान',
  welcome: {
    tagline: 'यहाँ हर कोई असली और सत्यापित है',
    quality: 'मात्रा नहीं, गुणवत्ता — एक बार में 5 मैच',
    privacy: 'आपका डेटा सुरक्षित है। आपकी आईडी कभी किसी मैच के साथ साझा नहीं की जाती।',
